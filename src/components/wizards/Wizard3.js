    ...
    render() {
        return (
            <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: 'black' }}>
                ...
                <Text style={{textAlign:'center', color:'white',fontSize:18,fontFamily:'IRANSansMobile_Bold'}}>از شنیدن موزیک لذت ببرید و آن را به اشتراک بگذارید</Text>
                <Image style={{ height: 300, borderRadius: 20, resizeMode: 'cover' }} source={require('../../assets/public/player.gif')} ></Image>
